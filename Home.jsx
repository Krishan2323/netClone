...
const apiKey = "e45463d488f67b1c363e66d82ac559b1"
...
const Home = () => {
    ...
    useEffect(() => {
        ...
        const fetchTopRated = async () => {
            const { data: { results },
            } = await axios.get(`${url}/movie/${topRated}?api_key=${apiKey}&page=4`)
            setTopRatedMovies(results)
        }
        const getAllGenre = async () => {
            const { data: { genres },
            } = await axios.get(`${url}/genre/movie//list?api_key=${apiKey}&page=5`)
            setGenre(genres)
        }
        getAllGenre()
        fetchTopRated()
